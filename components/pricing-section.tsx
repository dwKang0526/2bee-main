      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            작업 금액은 기능별 난이도 × 예상 투입일수를 기준으로 산정합니다.{" "}
            <br />
            아래 표는 견적 산정 시 사용하는 기준 단가입니다.
          </p>
        </div>
          ...
          <Card className="bg-card border-border">
            ...
            <CardContent>
              ...
              <div className="mt-6 p-4 rounded-lg bg-muted/50 text-sm text-muted-foreground leading-relaxed">
                <p className="mb-2">
                  실제 견적은 요구사항의 구체성, 화면 수, 연동 범위, 예외 처리,
                  유지보수 난이도 등에 따라 달라질 수 있습니다.
                </p>
              ...
              <div className="mt-6 text-center">
                <Button asChild>
                  <Link href="/pricing">단가 안내 전체 보기</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
